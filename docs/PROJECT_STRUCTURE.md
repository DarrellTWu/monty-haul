...
status: shipped
updated: 2026-07-13
purpose: Canonical file-layout reference. Source of truth — CLAUDE.md and tech_spec.md link here, do not duplicate. Last bump: review-fix sprint (payload hardening + onUncaughtException, CORS Authorization, username validation, extract_committed ack).
---
